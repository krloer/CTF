...
async function initialize () {
  if (id === null) {
    ...
    const snap = await getDoc(doc(db, 'sessioncracker', id)) //sessioncracker = database/table name?
    data = snap.data()
    sessionEle.innerText = JSON.stringify(data)
  }
}
...
/*
curl -v -X POST "https://firebaseremoteconfig.googleapis.com/v1/projects/617149347368/namespaces/firebase:fetch?key=AIzaSyDN_2EZMN-1QCJ4V13WYUTV4UKA4Im8lLM" -H "Content-Type: application/json" --data '{"appId": "1:617149347368:web:e34a2bf5fe52fb1b77a71d", "appInstanceId": "PROD"}'
*/