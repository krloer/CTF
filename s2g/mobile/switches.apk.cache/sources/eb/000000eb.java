...
public interface GL20 {
    ...
    String glGetActiveAttrib(int i, int i2, IntBuffer intBuffer, IntBuffer intBuffer2);

    String glGetActiveUniform(int i, int i2, IntBuffer intBuffer, IntBuffer intBuffer2);

    void glGetAttachedShaders(int i, int i2, Buffer buffer, IntBuffer intBuffer);

    int glGetAttribLocation(int i, String str);

    void glGetBooleanv(int i, Buffer buffer);
    ...
    void glGetVertexAttribPointerv(int i, int i2, Buffer buffer);
